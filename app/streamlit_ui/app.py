...
def show_conditions_section():
    ...
    with col2:
        cohort_filter = st.text_input("Cohort ID (optional)", placeholder="e.g., cohort1", key="conditions_cohort")
        cohort_filter = cohort_filter.strip() if cohort_filter else None
...
def show_observations_section():
    ...
    with col2:
        cohort_filter = st.text_input("Cohort ID (optional)", placeholder="e.g., cohort1", key="observations_cohort")
        cohort_filter = cohort_filter.strip() if cohort_filter else None
...
def show_procedures_section():
    ...
    with col2:
        cohort_filter = st.text_input("Cohort ID (optional)", placeholder="e.g., cohort1", key="procedures_cohort")
        cohort_filter = cohort_filter.strip() if cohort_filter else None
